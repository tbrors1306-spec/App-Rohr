...
# 1. DESIGN & CONFIG
# -----------------------------------------------------------------------------
st.set_page_config(page_title="Rohrbau Profi 7.1", page_icon="🛠️", layout="wide")
...
# 2. HILFSFUNKTIONEN
# -----------------------------------------------------------------------------
# Datenbanken (Schrauben & Wandstärken)
schrauben_db = {
...
with tab8:
    ...
    # -------------------------------------------------------------------------
        ...
        if cut_zma:
            umfang = da * math.pi
            n_diamond = math.ceil((umfang * cut_anzahl) / 60000) 
        ...
        cost_mat = (n_steel * p_stahl_disc) + (n_diamond * p_dia_disc)
